...
import { Check, ChevronDown, Heading1, Heading2, Heading3, TextQuote, ListOrdered, Text as TextIcon, Code, CheckSquare } from "lucide-react";
...
export const NodeSelector = ({ open, onOpenChange }: NodeSelectorProps) => {
  ...
  return (
    <Popover.Root open={open} onOpenChange={onOpenChange}>
      ...
      <Popover.Content sideOffset={6} align="start" className="z-50 w-48 rounded border bg-background p-1 shadow-xl outline-none">
